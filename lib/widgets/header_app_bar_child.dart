...
class HeaderAppBarChild extends BaseScreen<HeaderAppBarController> {
  HeaderAppBarChild({required this.title, this.iconLeft, this.iconRight, required this.functionLeft, required this.functionRight, Key? key}) : super(key: key);
  ...
  Widget _appBarButton(BuildContext context){
    return IconButton(
      icon: iconLeft ?? const Icon(Icons.arrow_back),
      iconSize: 30.0,
      color: Colors.white,
      onPressed: () {
        functionLeft();
