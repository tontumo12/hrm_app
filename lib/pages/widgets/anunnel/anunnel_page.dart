                    ...
                    children: [
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text('Nghỉ phép năm', style: TextUtils().boldQuickSand.copyWith(
                              fontSize: 14,
                            ...
                            Row(
                              children: [
                                ...
                                Text('08:00 22/06/2022 - 17:00 22/06/2022', style: TextUtils().mediumQuickSand.copyWith(
                                  fontSize: 12,
                                  fontWeight: FontWeight.bold
                                )),
                              ],
                            ...
                            Row(
                              children: [
                                ...
                                Text('Chờ duyệt', style: TextUtils().mediumQuickSand.copyWith(
                                  fontSize: 12,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.yellow
                                )),
